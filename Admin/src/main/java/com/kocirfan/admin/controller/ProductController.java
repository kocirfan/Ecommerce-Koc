package com.kocirfan.admin.controller;
...
public class ProductController {
    ...
    public String updateProductForm(@PathVariable("id") Long id, Model model, Principal principal) {
        ...
        model.addAttribute("title", "UpdateProducts");
        List<Category> categories = categoryService.findAllByActivated();
    ...
    public String productUpdate(@PathVariable("id") Long id, @ModelAttribute("productDto") ProductDto productDto, @RequestParam("imageProduct") MultipartFile imageProduct, RedirectAttributes attributes) {
        try {
    ...
    public String enabledProduct(@PathVariable("id") Long id, RedirectAttributes attributes) {
        try{
            ...
            attributes.addFlashAttribute("success", "Enabled successfuly!");
        }catch (Exception e){
            e.printStackTrace();
    ...
    public String deleteProduct(@PathVariable("id") Long id, RedirectAttributes attributes){
        try{
            ...
            attributes.addFlashAttribute("success", "Deleted successfuly!");
        }catch (Exception e){
            e.printStackTrace();
